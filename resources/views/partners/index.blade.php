...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and track all partners and their investments</p>
        </div>
        <div class="flex items-center gap-3">
            <button @click="window.dispatchEvent(new CustomEvent('refresh-partners'))" 
    ...
    <!-- Stats Cards -->
    @include('partials.card.partners-stats-card')

    <!-- Partner Table (Contains ALL modals) -->
    @include('partials.table.table-partners', ['partners' => $partners])
</div>
@endsection