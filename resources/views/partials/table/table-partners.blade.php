{{-- resources/views/partials/table/table-partners.blade.php --}}
@php
    $partners = $partners ?? [];
    $users = $users ?? [];
@endphp
      ...
      @empty
        <tr>
          <td colspan="7" class="py-8 text-center">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No partners found</h3>
...
function partnerTable() {
    return {
        ...
        showPartner(id) {
            ...
            if (partner) {
                window.dispatchEvent(new CustomEvent('show-partner', {
                    detail: { partner }
                }));
            }
        },
